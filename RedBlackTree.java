...
public class RedBlackTree {
    ...
    // this function perform left rotation
    ...
    //this function peforms right rotation
    ...
    boolean lr = false;
    boolean rl = false;
    // helper function for insertion. Actually this function performs all task in single pass only.
    Node insertHelp(Node root, int data) {
        ...
        if(f) {
            // to check which called is the current node of its parent 
